...
public class ClassifyUtil2 {
    ...
    public static Map<String, Double> classify(List<Flow> trains, Flow flow) {
        ...
        try {
            ...
            Object[] result = tx.getFeature(1,d, Constant.NCLASS,getDoubleArr(trains),Constant.NNN,Constant.FNUM);
    ...
    public static Map<String, Double> getThreshold(List<Flow> flows) {
        ...
        try {
            ...
            Object[] result = tx.getThreshold(1, Constant.NCLASS, Constant.NNN, Constant.FNUM, input);
